            ...
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                ...
                {tarefas.map((row, indice) => (
                    ...
                    >
                      ...
                      <TableCell align="right">{moment(row.inicioTarefa).format('DD/MM/YYYY')}</TableCell>
                      <TableCell align="right">{moment(row.fimTarefa).format('DD/MM/YYYY')}</TableCell>
                      <TableCell align="right">{row.statusTarefa}</TableCell>
                      <TableCell align="right">{row.recursoTarefa}</TableCell>
                      <TableCell align="center">
                        <Button  size="small" variant="contained" color="success" onClick={() => handleEditar(row.idTarefa)}>
